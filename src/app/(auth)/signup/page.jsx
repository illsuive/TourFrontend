...
// Importing standard Lucide icons for visual feedback
...
export default function SignupPage() {
  ...
  useEffect(() => {
    ...
    return () => clearError(); // Flush operational validation errors on unmount
      ...
      <div className="w-full max-w-md space-y-8 bg-white p-6 sm:p-8 rounded-2xl shadow-md border border-gray-100">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign up to generate customized, sandboxed AI travel itineraries.
          </p>
        </div>

        {/* Dynamic Server Error Feedback */}
        {error && (
          <div className="rounded-lg bg-red-50 p-3 text-sm text-red-600 border border-red-200 animate-fadeIn">
            <div className="flex">
              <span>{error}</span>
            </div>
          </div>
